...
import copyandvib , {openLink} from "../../../../Global/functions/copyandvib.js";
import styles from "./Evolved.module.css";

function Evolved() {
  return (
    <article className="round no-elevate no-margin primary-container">
        <div className="row tiny-margin">
          <img alt="" className="large circle small-padding" src={blanket} />
          <div >
            <h5 className={`center-align ${styles.title}`}>{string.evolved.title}</h5>
          </div>
        </div>
